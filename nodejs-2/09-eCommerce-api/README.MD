...
- The signed flag indicates if the cookie is signed. It detects if the client has modified the cookie
- File: utils/jwt.js
...
- File: app.js
  ...
  - To access the signed cookie, it's in req.signedCookies
  ```js
